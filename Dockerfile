...
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter tool
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter platform-tool
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter platform
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter extra
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter add-on
RUN echo "y\ny\ny\ny\ny\ny" | android update sdk --all --no-ui --filter system-image
