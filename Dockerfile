...
RUN (while [ 1 ]; do sleep 1; echo y; done ) | android update sdk --no-ui --all --filter android-23,build-tools-23.0.2,extra-android-m2repository,extra-google-m2repository
