...
RUN echo "y\ry\r\ny\n\ryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy" | android update sdk --no-ui --filter tool
RUN echo "y\ry\r\ny\n\ryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy" | android update sdk --no-ui --filter platform-tool
